  ...
  maintainAspectRatio: true,
    ...
    scales: {
      ...
      yAxes: [{
        ...
        scaleLabel: {
          display: true,
          labelString: 'Onaylanmış (bugün / dün) | Confirmed (today / yesterday)'
        },  
        ticks: {
          min: 0.9,
          autoSkip:true,
...
export var lineDataTotal = {
    ...
    {
      type: "line",
      label: "Toplam Vaka | Total Cases",
      legendText: "Aktif | Active",
      fill: false,
      backgroundColor: "#555",
      borderColor: "#555",
      // borderCapStyle: 'butt',
    ...
    {
      label: "Onaylanmış | Confirmed",
      legendText: "Onaylanmış | Confirmed",
      fill: false,
    ...
    {
      label: "İyileşen | Recovered",
      legendText: "İyileşen | Recovered",
      fill: false,
