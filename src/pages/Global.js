...
export default function Global() {
    ...
    fetch("https://raw.githubusercontent.com/LastBugStanding/covid/master/countrywise.json")
        ...
        <Async promiseFn={loadUsers} >
                {({ data, err, isLoading }) => {
                    ...
                    if (data)
                      ...
                      lineDataCountrywise.labels = [...Array(data.counts["Cyprus"].length).keys()];
                      lineDataCountrywise.datasets = [];
                     // console.log(data.counts);
                     var countries = ["Turkey", "Cyprus", "Spain", "Italy", "US"];
                      ...
                      lineDataCountrywiseInfectionRate.labels = [...Array(data.counts["Cyprus"].length).keys()];
                      lineDataCountrywiseMortalityRate.labels = [...Array(data.counts["Cyprus"].length).keys()];
                      lineDataCountrywiseFatalityRate.labels = [...Array(data.counts["Cyprus"].length).keys()];
                        ...
                        <>
                          <Helmet>
                           <title>Analytics Between Countries</title>
                            ...
                            <meta name="description" content="Comparision between Turkey, Cyprus, Itlay, USA and Spain"  data-react-helmet="true" />
